...
class TennisGameTest extends TestCase
{
   ...
   * @test
   */
  public function getGameScore_Give3vs4_ReturnAdvPlayer2()
  {
    //Arrange
    $p1_score = 3;
    $p2_score = 4;
   ...
   * @test
   */
  public function getGameScore_Give4vs5_ReturnAdvPlayer2()
  {
    //Arrange
    $p1_score = 4;
    $p2_score = 5;
   ...
   * @test
   */
  public function getGameScore_Give5vs3_ReturnWinForPlayer1()
  {
    //Arrange
    $p1_score = 5;
    $p2_score = 3;
   ...
   * @test
   */
  public function getGameScore_Give2vs4_ReturnWinForPlayer2()
  {
    //Arrange
    $p1_score = 2;
    $p2_score = 4;
